...
<template>
    <div class="card bg-surface-card p-6 rounded-xl shadow-sm">
        ...
        <div class="mb-3 flex items-center justify-between">
            <div>
                <span class="text-xl font-medium text-surface-900 dark:text-surface-0">รายงานภาษี / ภาษีขาย</span>
        ...
        <div class="report-container">
            ...
            <div class="mb-4">
                ...
                <div class="flex justify-center items-center flex-col">
                    <div class="font-bold text-xl mb-0">รายงานภาษีขาย</div>
            ...
            <DataTable v-model:expandedRows="expandedRows" :value="paginatedData" dataKey="docno" showGridlines size="small" :rowHover="true" @row-click="onRowClick">
                ...
                <Column field="custname" header="ชื่อผู้ซื้อสินค้า/ผู้รับบริการ" style="min-width: 200px">
                    <template #body="{ data }">
                        {{ data.custname || '-' }}
                    </template>
                </Column>
                ...
                <Column header="ฐานภาษี" style="width: 120px" headerClass="text-center" bodyClass="text-right">
                    <template #body="{ data }">
                        {{ formatCurrency(data.vatbase || 0) }}
                    </template>
                </Column>
                ...
                <Column header="ยกเว้นภาษี" style="width: 120px" headerClass="text-center" bodyClass="text-right">
                    <template #body="{ data }">
                        {{ formatCurrency(data.exceptvat) }}
                    </template>
                </Column>
