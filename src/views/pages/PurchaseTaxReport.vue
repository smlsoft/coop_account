...
<template>
    <div class="card bg-surface-card p-6 rounded-xl shadow-sm">
        ...
        <div class="report-container">
            ...
            <DataTable :key="'purchase-tax-table'" v-model:expandedRows="expandedRows" scrollable scrollHeight="calc(100vh - 366px)" :value="paginatedData" dataKey="_uniqueId" showGridlines size="small" :rowHover="true" @row-click="onRowClick">
                ...
                <ColumnGroup v-if="reportData.length > 0" type="footer">
                    <Row>
                        ...
                        <Column :footer="formatCurrency(getTotalVatBase)" :pt="{ footerCell: { style: 'width: 130px; text-align: right; font-weight: bold' } }" />
                        <Column :footer="formatCurrency(getTotalVatAmount)" :pt="{ footerCell: { style: 'width: 120px; text-align: right; font-weight: bold' } }" />
                        <Column :footer="formatCurrency(getTotalAmount)" :pt="{ footerCell: { style: 'width: 120px; text-align: right; font-weight: bold' } }" />
                        <Column footer="" :pt="{ footerCell: { style: 'width: 100px' } }" />
                    </Row>
                </ColumnGroup>
            </DataTable>
