...
const handleSubmit = () => {
    ...
    if (formData.value.customertype === 2 && (!formData.value.branchnumber || !formData.value.branchnumber.trim())) {
        isBranchNumberInvalid.value = true;
        hasError = true;
    }
            ...
            <form v-else @submit.prevent="handleSubmit" class="flex flex-col gap-6">
                ...
                <div class="flex flex-col md:flex-row gap-6">
                    <div class="flex flex-col gap-2 md:w-1/2">
                        <label for="code" class="font-semibold text-surfa$router.push(config.route)text-surface-0">
                ...
                <!-- Row 2: ประเภทบุคคล และ เลขที่ผู้เสียภาษี -->
                <div class="flex flex-col md:flex-row gap-6">
                    <div class="flex flex-col gap-2 md:w-1/2">
                ...
                <!-- Row 4: ที่อยู่ และ เบอร์โทรศัพท์ -->
                <div class="flex flex-col md:flex-row gap-6">
                    <div class="flex flex-col gap-2 md:w-1/2">
                    ...
                    <div class="flex flex-col gap-2 md:w-1/2">
                        ...
                        <InputText id="phoneprimary" v-model="formData.phoneprimary" placeholder="กรอกหมายเลขโทรศัพท์" />
                    </div>
                </div>
