...
<template>
    <div class="card bg-surface-card p-6 rounded-xl shadow-sm">
        ...
        <div class="mb-3 flex items-center justify-between">
            <div>
                <span class="text-xl font-medium text-surface-900 dark:text-surface-0">รายงานภาษี / ภาษีหัก ณ ที่จ่าย (ภ.ง.ด.53)</span>
        ...
        <div class="report-container">
            ...
            <div class="mb-4">
                ...
                <div class="flex justify-center items-center flex-col">
                    <div class="font-bold text-xl mb-0">รายงานภาษีหัก ณ ที่จ่าย (ภ.ง.ด.53)</div>
